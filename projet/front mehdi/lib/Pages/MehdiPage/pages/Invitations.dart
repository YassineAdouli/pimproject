...
class _Invitation extends State<Invitation> {
          ...
          child: new ListView.builder(
              ...
              itemBuilder: (BuildContext cntxt, int indexx) {
                return new Column(children: <Widget>[
                  if (ListOfMeets.M[indexx].status == "Pending" &&
                      ListOfMeets.M[indexx].emailC == userModel.email)
                    Center(
                      child: Container(
  ...
  Future<List<Rdv>> getMeets() async {
    final urlList = ["http://192.168.43.13:5000/Rdv/findRdv"];
    print("bobo");
