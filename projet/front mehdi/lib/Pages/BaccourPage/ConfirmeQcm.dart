...
class _Ajout_Qcm_Form extends State<Ajout_Qcm_Form> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(home: Scaffold(body: TestForm()));
  }
}
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            new IconButton(
                ...
                onPressed: () {
                  setState(() {
                    print(Ajout_Offer_Form.model.skill);
                  });
                })
          ],
        ),
...
print(fList[0]);
  ...
  Future<List<Question>> findquestion() async {
    final urlList = ["http://192.168.1.144:5000/question/findquestion"];
    print("dfdfg");
    final responses = await Future.wait(
      urlList.map((String url) {
        return http.get(url);
