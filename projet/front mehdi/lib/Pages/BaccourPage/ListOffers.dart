...
class _ListOfferState extends State<ListOffer> with TickerProviderStateMixin {
  ...
  Future<List<Offer>> getOffer() async {
    final urlList = ["http://192.168.43.13:5000/annonce/findoffer"];
    print("dfdfg");
