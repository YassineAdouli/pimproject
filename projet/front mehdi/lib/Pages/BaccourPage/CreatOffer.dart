...
class _TestFormState extends State<TestForm> {
          ...
          children: <Widget>[
            MyText(
              ...
              onSaved: (String value) {
                Ajout_Offer_Form.model.titre = value;
              },
            ),
            DropdownButton(
              ...
              onChanged: (newValue) {
                ...
                Ajout_Offer_Form.model.skill = skilstring;
              },
            ...
            NumberPicker(
              ...
              onChanged: (value) => setState(() => {
                    Ajout_Offer_Form.model.experience = value.toString(),
                    _currentValue = value,
  ...
  void saveOffer(Offer q) async {
    ...
    final response = await http.post(
      "http://192.168.43.13:5000/offer/addannonce",
